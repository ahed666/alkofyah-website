...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Tajawal:wght@400;500;700&family=Cairo:wght@400;500;700&family=Roboto:wght@400;500&display=swap" rel="stylesheet">
    ...
    <link rel="icon" type="image/png" href="{{asset('img/logo/favicon.ico')}}">
...
<body>
   ...
   <x-footer/>
    ...
    class="whatsapp-btn btn btn-lg btn-primary btn-lg-square rounded-circle">
