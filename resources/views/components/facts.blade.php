<div class="container-xxl py-6">
        <div class="container">
        <div class="grid justify-content-start  mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" 
        style="max-width: 100%;">
                <p class="text-primary text-uppercase mb-2">// {{__('app.sections_titles.facts_title')}}</p>
                <h1 class="display-6 mb-4" style="max-width:500px">{{__('app.sections_titles.facts_sub_title')}}</h1>
            </div>
            <div class="row g-4">
